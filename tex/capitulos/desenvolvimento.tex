...
\begin{figure}[htb]
    ...
    \centering
    \includegraphics[scale=1]{images/resultado_97}
    \fautor
\end{figure}
...
\begin{figure}[htb]
    ...
    \centering
    \includegraphics[scale=1]{images/resultado_79}
    \fautor
\end{figure}
